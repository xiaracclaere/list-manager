...
sv = "12o1s1"
global main_choices
main_choices = ["Add", "Delete", "List", "Clean", "Sort", "New", "Lists", "Export", "Help", "History", "Exit"]
global debug_choices
debug_choices = ["Add", "Delete", "List", "Clean", "Clear", "Sort", "Export", "Timer", "Performance", "Use", "Reset", "Code", "Help", "Mode", "History", "Exit"]
...
def debug_mode():
    ...
    global using
    global timer
    print(cui(style5, debug_choices), "\n")
    action = input().strip().lower()
