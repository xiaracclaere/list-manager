...
Version = 11
News:
- Debug Mode is completed!
Happy News:
The code increased from 537 to {lns} lines!
...
def main():
    ...
    print('Welcome to the List Manager! You can write "help" to get help. Version = 11 ')
...
"""
List Manager Version 11
COPYRIGHT 2025 © Xiara Cclaere
EVERYTHING WILL BE DEBUGGED!
"""