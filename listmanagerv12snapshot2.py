...
def switch_mode():
    ...
    if mode == 0:
        functions.clear()
        print('Welcome to the List Manager Debug Mode! Write "help" to get help. Version = 12s2 \n')
        mode = 1
    else:
        functions.clear()
        print('Welcome to the List Manager! Write "help" to get help. Version = 12s2 \n')
        fun_fact()
        mode = 0
...
Version = 12s2
News:
- Now errors are importing from other files!
Happy News:
The code decreased from 978 to {lns} lines, because of the new error control system.
...
def main():
    ...
    print('Welcome to the List Manager! You can write "help" to get help. Version = 12s2 \n')
...
"""
List Manager Version 12 Snapshot 2(Complete)
