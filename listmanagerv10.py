...
Code: Shows the code of the program.
...
def main():
    ...
    print('Welcome to the List Manager! You can write "help" to get help. Version = 10.0 ')
    
    while True:
        action = input(f"| Add | Delete | List | Clean | Sort | New | Export | Help | Reset | Code | Exit | \n").strip().lower()
