...
- 
Happy News:
The code decreased from 842 to {lns} lines!
...
def main():
    ...
    print('Welcome to the List Manager! You can write "help" to get help. Version = 12s3 \n')
...
"""
List Manager Version 12 Snapshot 3(Complete)
