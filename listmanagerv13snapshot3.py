...
fun_facts   = ["The longest word in the English language is 'pneumonoultramicroscopicsilicovolcanoconiosis'.",
            ...
            "ğüışöçĞÜİŞÖÇ are Turkish characters, but they are not in the English language.",
            "qwx are in the English language, but they are not in the Turkish language.",
            "If you are reading this, you are not a robot. (again)",
            "I have a question, but you can't answer. Why? Because you this is just a fun fact text."
            ]
