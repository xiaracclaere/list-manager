...
def switch_mode():
    ...
    if mode == 0:
        functions.clear()
        print('Welcome to the List Manager Debug Mode! Write "help" to get help. Version = 12s1 \n')
        mode = 1
    else:
        functions.clear()
        print('Welcome to the List Manager! Write "help" to get help. Version = 12s1 \n')
        fun_fact()
        mode = 0
...
-
Happy News:
The code increased from 974 to {lns} lines!
...
def main():
    ...
    print('Welcome to the List Manager! You can write "help" to get help. Version = 11.3 ')
...
"""
List Manager Version 12 Snapshot 1(Complete)
