...
- 
Happy News:
The code increased from 384 to {lns} lines!
...
def main():
    ...
    print('Welcome to the List Manager! You can write "help" to get help. Version = 11s2 ')
...
"""
List Manager Version 11 Snapshot 2(Complete)
