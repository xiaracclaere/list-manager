...
import os, pickle, time, keyboard, psutil
...
Version = 11.1
News:
- Debug Mode is upgraded!
Happy News:
The code increased from 626 to {lns} lines!
...
def main():
    ...
    print('Welcome to the List Manager! You can write "help" to get help. Version = 11.1 ')
